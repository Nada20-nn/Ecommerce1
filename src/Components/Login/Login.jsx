    ...
    <div className="pt-28">
      ...
      <form onSubmit={formik.handleSubmit} className=" mt-5 mx-auto">
        ...
        <div className=" flex justify-between items-center">
          ...
          >
            {isLoading ? <FaSpaghettiMonsterFlying className="animate-spin" /> : "Submit"}
          </button>
          <Link to='/forgetpassword' className=' text-xl text-green-600 hover:underline'> forget password ? </Link>
        </div>
      </form>
    </div>
  );
